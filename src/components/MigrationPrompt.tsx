...
export function MigrationPrompt({ status, onUpload, onSkip, onDismiss }: Props) {
  if (
    status.stage === "idle" ||
            ...
            <div className="mb-5 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1.5 text-sm text-slate-600">
                  ...
                  saved locally. Upload it to your account to keep it safe and sync across devices.
                </p>
        ...
        {status.stage === "error" && (
          <>
            <div className="mb-5 flex items-start gap-3">
              ...
              <div>
                <h2 className="text-base font-semibold text-slate-800">Upload failed</h2>
